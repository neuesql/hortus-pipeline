...
public:
    ...
    // Write methods
    void PersistView(DatabaseInstance &db, const string &database, const string &name,
    ...
    void UpdateViewQuery(DatabaseInstance &db, const string &database, const string &name,
                         const string &query);
    ...
    void UpdateSchedulePaused(DatabaseInstance &db, const string &database, const string &name,
                              bool paused);
    ...
    void CompleteRunLog(DatabaseInstance &db, const string &database, int64_t run_id,
