...
TableFunction GetRefreshMaterializedViewFunction() {
	TableFunction func("pipeline_refresh_mv", {LogicalType::VARCHAR, LogicalType::VARCHAR}, RefreshMVFunc,
	                   RefreshMVBind, RefreshMVInit);
	return func;
}
...
TableFunction GetRefreshAllMaterializedViewsFunction() {
	TableFunction func("pipeline_refresh_all_mvs", {LogicalType::VARCHAR}, RefreshAllMVFunc, RefreshAllMVBind,
	                   RefreshAllMVInit);
	return func;
}
